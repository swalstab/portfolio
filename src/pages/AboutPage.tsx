...
markup
  .set(
    ...
    <span className="highlight coding">coding</span> and decided to make 
    it my new career.
    <br />
    When I’m not coding, you’ll probably find me
    <span className="highlight running">running</span>. I’m fascinated by 
    the challenge of marathons and ultramarathons, and I love pushing my 
    limits, both on the road and in code.`
  )
  .set(
    "german",
    ...
    Begeisterung fürs <span className="highlight coding">Programmieren</span> 
    ...
    <span className="highlight running">Laufen</span>. Besonders Marathons und 
  ...
  .set(
    ...
    por la <span className="highlight coding">programación</span> y decidí 
    cambiar de rumbo profesional.
    <br />
    Cuando no estoy programando, probablemente estoy 
    <span className="highlight running">corriendo</span>. Me atraen especialmente 
